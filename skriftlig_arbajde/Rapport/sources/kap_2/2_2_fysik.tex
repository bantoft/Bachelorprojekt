...
\begin{align}
    &\frac{\partial n}{\partial t} + \nabla \cdot (n \mathbf{V}) = 0 \label{eq:Braginsiis kontinuitetsligning}\\
...
\end{align}
Ligning \eqref{eq:Braginsiis kontinuitetsligning} kaldes kontinuitetsligningen og beskriver bevarelsen af partikler.
...
\end{align}
Braginskii's energi transport ligning\eqref{eq:Braginskii's energitransport ligning} beskriver bevarelsen af 
