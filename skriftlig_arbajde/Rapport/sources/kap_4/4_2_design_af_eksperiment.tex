...
Domænet for antal lag, aktiveringsfunktioner og hidden dimension blev diskuteret i afsnit \ref{ch2_1_2}. På den baggrund undersøges følgende kombinationer:
\begin{equation*}
\begin{aligned}
